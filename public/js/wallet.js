...
const _WALLET_STRINGS = {
  ar: { greeting: 'مرحبًا', praxis: 'براكسيس', vault: 'الخزينة', manage: 'إدارة', signout: 'تسجيل الخروج' },
  bn: { greeting: 'হাই', praxis: 'প্র্যাক্সিস', vault: 'ভল্ট', manage: 'পরিচালনা', signout: 'সাইন আউট' },
  ...
  es: { greeting: 'hola', praxis: 'praxis', vault: 'bóveda', manage: 'gestionar', signout: 'cerrar sesión' },
  fa: { greeting: 'سلام', praxis: 'پراکسیس', vault: 'خزانه', manage: 'مدیریت', signout: 'خروج' },
  fr: { greeting: 'salut', praxis: 'praxis', vault: 'coffre', manage: 'gérer', signout: 'se déconnecter' },
  hi: { greeting: 'नमस्ते', praxis: 'प्रैक्सिस', vault: 'तिजोरी', manage: 'प्रबंधन', signout: 'साइन आउट' },
  id: { greeting: 'hai', praxis: 'praxis', vault: 'brankas', manage: 'kelola', signout: 'keluar' },
  ja: { greeting: 'こんにちは', praxis: 'プラクシス', vault: '金庫', manage: '管理', signout: 'サインアウト' },
  ko: { greeting: '안녕', praxis: '프락시스', vault: '금고', manage: '관리', signout: '로그아웃' },
  pt: { greeting: 'olá', praxis: 'práxis', vault: 'cofre', manage: 'gerenciar', signout: 'sair' },
  ru: { greeting: 'привет', praxis: 'праксис', vault: 'хранилище', manage: 'управление', signout: 'выйти' },
  sv: { greeting: 'hej', praxis: 'praxis', vault: 'valv', manage: 'hantera', signout: 'logga ut' },
  sw: { greeting: 'hujambo', praxis: 'praxis', vault: 'hazina', manage: 'dhibiti', signout: 'ondoka' },
  tr: { greeting: 'merhaba', praxis: 'praksis', vault: 'kasa', manage: 'yönet', signout: 'çıkış' },
  ur: { greeting: 'ہیلو', praxis: 'پریکسس', vault: 'تجوری', manage: 'انتظام', signout: 'سائن آؤٹ' },
  vi: { greeting: 'chào', praxis: 'praxis', vault: 'kho', manage: 'quản lý', signout: 'đăng xuất' },
