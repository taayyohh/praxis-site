...
async function submitPost() {
  ...
  try {
    ...
    // Follower notification: the Ponder-indexed `Posted` event flows
    // into feed.js (rendered as a rich preview card for followed
    // artists) and into notifications.js (aggregated `new_post_from_followed`
    // event). Both surfaces are passive — no XMTP fan-out from here,
    // because the inbox is for personal messages, not broadcasts.
